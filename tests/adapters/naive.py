...
`--adapter tests.adapters./Users/hneogy/Library/CloudStorage/Dropbox/Code Files/gp-omm-conformance/gp-omm-conformance/naivearser`, the tests and the published documents that cite it keep working: importing
