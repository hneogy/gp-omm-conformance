...
CASES = [
    ...
    },
    {
        ...
        "coverage": {"provides": ["256 six-digit ids 100404-100789 in CSV", "TLE request -> 404 with body 'No GP data found' (captured twice, 00:10Z hand-recorded and 00:41Z clean)", "11 records with non-zero second derivative", "negative BSTAR values"],
    ...
    },
    {
        ...
        "title": "Nine-digit catalog numbers: 18 SDS launch nominals (7995016xx) in CelesTrak SupGP data",
        "kind": "gp",
        ...
        "coverage": {"provides": ["one 9-digit object (799501621) in CSV, JSON, XML and KVN; TLE request -> 404 'No SupGP data found'", "27 nine-digit ids 799501621-799501647 in the full Starlink SupGP file at the snapshot"],
                     "gaps": ["perishable: nominals exist only for roughly 5-8 days after a launch (CelesTrak); a user's fetch may contain none, in which case the case reports 'no 9-digit ids available now' rather than failing", "no 9-digit id exists in 18 SDS GP data; only SupGP"]},
    ...
    },
    {
        ...
        "title": "Alpha-5 encode/decode vectors from the Space-Track table, with boundaries and invalid inputs",
        "kind": "vectors",
