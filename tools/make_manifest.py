...
LIBRARY_FINDINGS = {
    ...
    "analyst-objects": ["python-sgp4 2.27 sgp4.omm.parse_xml returns None for an empty <OBJECT_ID/> element and initialize() then raises TypeError; 564 of the 566 analyst XML records in the case (563 of the 565 group records, plus the single 270449 first record) fail, while the same records in CSV pass."],
